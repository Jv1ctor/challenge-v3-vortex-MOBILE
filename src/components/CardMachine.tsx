  ...
  return (
    <Pressable
      ...
      <View className="pr-2 pt-2">
        <View className="absolute bottom-0 left-0 top-2 w-2 h-full rounded-l-md bg-primary" />
        <View className="ml-2 overflow-hidden rounded-r-md bg-card" style={styles.shadow}>
          <View className="p-4">
            ...
            <Text className="mt-1 text-sm text-mutedForeground">Último registro: {lastRecord}</Text>
          </View>
